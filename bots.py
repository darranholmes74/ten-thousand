...
class YourBot(BaseBot):
    ...
    # def _end_turn(self, turn_score):
    #     super()._end_turn(turn_score)
    #     if self.is_winner():
    #         self.highest_scores.append(self.total_score)
    #
    # def get_average_highest_score(self):
    #     if not self.highest_scores:
    #         return 0
    #     return sum(self.highest_scores) / len(self.highest_scores)
